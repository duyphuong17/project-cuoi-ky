import "./KhoaHocIELTS.css"

function KhoaHocIELTS() {
    return (
        <>
            <div className="kh-ie-1" style={{ backgroundImage: `url(/image/kh-ie-1.1.jpg)` }}>
                <div className="kh-ie-1-content">
                    <h2>
                        HỌC IELTS ONLINE
                        <br />
                        CHẤT LƯỢNG CAO
            ...
            {/* kh-ie-2 */}
            <div className="kh-ie-2">
                <h2>Our Clients</h2>
                <div className="kh-ie-2-image">
                    <img src="/image/kh-ie-2.1.jpg" />
                    <img src="/image/kh-ie-2.2.jpg" />
                    <img src="/image/kh-ie-2.3.jpg" />
                    <img src="/image/kh-ie-2.4.jpg" />
                    <img src="/image/kh-ie-2.5.jpg" />
                    <img src="/image/kh-ie-2.6.jpg" />
                </div>
            </div>
            {/* kh-ie-3 */}
            <div className="kh-ie-3">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 kh-ie-3-image">
                        <img src="/image/kh-ie-3.5.png" />
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 kh-ie-3-main">
                        <h2>YÊN TÂM HỌC IELTS VỚI HỢP ĐỒNG CAM KẾT ĐẦU RA</h2>
                        <p className="kh-ie-3-title">Với chương trình cam kết đầu ra của Patado, bạn sẽ đạt được:</p>
                        <div className="kh-ie-3-content">
                            <div className="kh-ie-3-decs">
                                <img src="/image/kh-ie-3.1.png" />
                                <p>
                                    <strong>
                                        TÀI TRỢ 100% CHI PHÍ THI TRỊ GIÁ 4.750.000Đ </strong>
            ...
            {/* kh-ie-4 */}
            <div className="kh-ie-4" style={{ backgroundImage: `url(/image/kh-ie-4.1.jpg)` }}>
                <h2>NHỮNG CON SỐ VỀ HỌC VIỆN </h2>
                <div className="kh-ie-4-content">
                    <div className="kh-4-ie-desc">
                        <span>10
                            <br />
            ...
            {/* kh-ie-5 */}
            <div className="kh-ie-5">
                <h2>Bốn tiêu chí tạo nên khóa học tại Patado</h2>
                <div className="row ">
                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 kh-ie-5-content">
                        <img src="/image/kh-ie-5.1.jpg" />
                        <div className="kh-ie-5-desc">
                            <span>Lộ trình tinh gọn, phương pháp độc đáo</span>
                            <p>Lộ trình tinh gọn tối ưu hoá thời gian học và cá nhân theo nhu cầu học viên. Tăng khả năng tự học và tự sửa lỗi cho học viên. Bài giảng được biên soạn bởi đội ngũ chuyên gia, giảng viên đại học, thạc sĩ du học khoa ngôn ngữ tiết kiệm tối đa thời gian cho học viên.</p>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 kh-ie-5-content">
                        <img src="/image/kh-ie-5.2.jpg" />
                        <div className="kh-ie-5-desc">
                            <span>Giáo viên tâm lý kinh nghiệm phong phú</span>
                            <p>Với ưu thế của việc giảng dạy trực tuyến, khoá học tại Patado giúp kết nối những giáo viên giỏi, tâm huyết trên khắp thế giới tới học viên. Kinh nghiệm phong phú từ các giáo viên du học, nhiệt huyết chia sẻ tạo động lực và cảm hứng cho học viên</p>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 kh-ie-5-content">
                        <img src="/image/kh-ie-5.3.jpg" />
                        <div className="kh-ie-5-desc">
                            <span>Chất lượng quốc tế chi phí nội địa</span>
                            <p>Ngoài việc giảng dạy thành công tại Việt Nam, Patado đã tự tín đóng gói và xuất khẩu chương trình học đến các nước lớn: Anh, Úc, Mỹ, Canada, Nhật, Hàn… Phục vụ đồng bào người việt với chi phí nội địa</p>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 kh-ie-5-content">
                        <img src="/image/kh-ie-5.4.jpg" />
                        <div className="kh-ie-5-desc">
                            <span>Tiết kiệm 25-30 % thời gian & chi phí học tập</span>
                            <p>Thực tế mỗi giáo viên sẽ có thế mạnh vượt trội trong 2/4 kỹ năng tại kỳ thi IELTS. Vì vậy ở giai đoạn bứt phá, một lớp học IELTS sẽ được bố trí 2 giáo viên để đảm bảo trọn vẹn 4 kỹ năng giúp bạn chuyên môn hóa từng kỹ năng. Ưu thế học trực tuyến tối ưu chi phí chỉ bằng 1/4 với học tại trung tâm và 1/2 so với học gia sư</p>
                        </div>
                    </div>
                </div>
            </div>
